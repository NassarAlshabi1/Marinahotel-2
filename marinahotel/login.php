            ...
            if ($stmt) {
                ...
                if ($result->num_rows === 1) {
                    ...
                    if ($password_valid) {
                        ...
                        // إضافة role للتوافق مع صفحات المصروفات
                        $_SESSION['role'] = ($user['user_type'] === 'admin') ? 'admin' : 'finance';
...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>assets/css/bootstrap-local.css">
    <link rel="stylesheet" href="<?= BASE_URL ?>assets/css/arabic-enhanced.css">
